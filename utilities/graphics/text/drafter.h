			...
			namespace text {
				struct drafter {
					struct line {
						...
						rects::xywh<int> get_rect() const; /* actual line rect */
					...
					vec2<int> view_caret(unsigned caret_pos, const rects::ltrb<int>& clipper) const; 
					...
					std::pair<int, int> get_line_visibility(const rects::ltrb<int>& clipper) const;
				private:
					unsigned max_x;
