...
namespace augs {
	...
	public:
		...
		void draw_debug_info(vec2 visible_world_area, components::transform, assets::texture_id tex, std::vector<const_entity_handle> target_entities, double interpolation_ratio);
