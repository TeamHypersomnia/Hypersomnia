...
namespace bindings {
	luabind::scope _entity() {
		return
			...
			.def("remove_position_copying", &entity::remove<position_copying>)
			.def("add", &entity::add<position_copying>)
			.property("position_copying", &entity::find<position_copying>, &entity::set<position_copying>)
			...
			.def("remove_rotation_copying", &entity::remove<rotation_copying>)
			.def("add", &entity::add<rotation_copying>)
			.property("rotation_copying", &entity::find<rotation_copying>, &entity::set<rotation_copying>)
			...
			.def("remove_position_copying", remove<position_copying>)
			.def("add", add<position_copying>)
			.property("position_copying", find<position_copying>, set<position_copying>)
			...
			.def("remove_rotation_copying", remove<rotation_copying>)
			.def("add", add<rotation_copying>)
			.property("rotation_copying", find<rotation_copying>, set<rotation_copying>)
