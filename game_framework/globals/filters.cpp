...
namespace filters {
	...
	b2Filter controlled_character() {
		...
		out.maskBits = RENDERABLE_QUERY | CONTROLLED_CHARACTER | STATIC_OBJECT | DYNAMIC_OBJECT | REMOTE_CHARACTER | FRICTION_GROUND | TRIGGER | BULLET | SHELL;
		return out;
	}
	...
	b2Filter friction_ground() {
		...
		out.maskBits = RENDERABLE_QUERY | CONTROLLED_CHARACTER | STATIC_OBJECT | DYNAMIC_OBJECT | REMOTE_CHARACTER | FRICTION_GROUND | SHELL;
		return out;
	}
	...
	b2Filter dynamic_object() {
		...
		out.maskBits = RENDERABLE_QUERY | CONTROLLED_CHARACTER | STATIC_OBJECT | DYNAMIC_OBJECT | REMOTE_CHARACTER | FRICTION_GROUND | BULLET | SHELL;
		return out;
	}
	...
	b2Filter static_object() {
		...
		out.maskBits = RENDERABLE_QUERY | CONTROLLED_CHARACTER | DYNAMIC_OBJECT | REMOTE_CHARACTER | FRICTION_GROUND | BULLET | SHELL;
		return out;
	}
