...
*([Our CI is due to be overhauled](https://github.com/TeamHypersomnia/Hypersomnia/issues/258). Currently, the game is only buildable under clang 6.0.1 and gcc 7.3.1; or newer ones.)*
