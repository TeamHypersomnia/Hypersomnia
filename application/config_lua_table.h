...
AUGS_INTROSPECT_BEGIN(config_lua_table)
	FIELD(launch_mode);
	...
	FIELD(hotbar.increase_inside_alpha_when_selected);
	FIELD(hotbar.colorize_inside_when_selected);

	FIELD(hotbar.primary_selected_color);
	FIELD(hotbar.secondary_selected_color);
AUGS_INTROSPECT_END