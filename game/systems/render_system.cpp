...
void render_system::draw_entities(augs::vertex_triangle_buffer& output, std::vector<const_entity_handle> entities, state_for_drawing_camera in_camera, bool only_border_highlights = false) const {
	for (auto e : entities) {
