...
namespace resource_setups {
	void load_standard_atlas() {
		...
		hud_circular_hud_medium.paint_circle_midpoint(71, 1, augs::white, true, -45, 45, false);
		hud_circular_hud_medium.paint_circle_midpoint(69, 8, augs::white, true, -45, 45, false);
