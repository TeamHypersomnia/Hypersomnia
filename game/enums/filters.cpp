...
namespace filters {
	...
	b2Filter controlled_character() {
		...
		out.maskBits = RENDERABLE_QUERY | CONTROLLED_CHARACTER | STATIC_OBJECT | DYNAMIC_OBJECT | FRICTION_GROUND | TRIGGER | BULLET | SHELL | CORPSE;
		return out;
	}
	...
	b2Filter corpse() {
		...
		out.maskBits = RENDERABLE_QUERY | CONTROLLED_CHARACTER | STATIC_OBJECT | DYNAMIC_OBJECT | FRICTION_GROUND | TRIGGER | SHELL | CORPSE;
		return out;
	}
	...
	b2Filter friction_ground() {
		...
		out.maskBits = RENDERABLE_QUERY | CONTROLLED_CHARACTER | STATIC_OBJECT | DYNAMIC_OBJECT | FRICTION_GROUND | SHELL | CORPSE;
		return out;
	}
	...
	b2Filter dynamic_object() {
		...
		out.maskBits = SIGHT_QUERY | PATHFINDING_QUERY | RENDERABLE_QUERY | CONTROLLED_CHARACTER | STATIC_OBJECT | DYNAMIC_OBJECT | FRICTION_GROUND | BULLET | SHELL | CORPSE;
		return out;
	}
	...
	b2Filter see_through_dynamic_object() {
		...
		out.maskBits = RENDERABLE_QUERY | CONTROLLED_CHARACTER | STATIC_OBJECT | DYNAMIC_OBJECT | FRICTION_GROUND | BULLET | SHELL | CORPSE;
		return out;
	}
	...
	b2Filter static_object() {
		...
		out.maskBits = SIGHT_QUERY | PATHFINDING_QUERY | RENDERABLE_QUERY | CONTROLLED_CHARACTER | DYNAMIC_OBJECT | FRICTION_GROUND | BULLET | SHELL | CORPSE;
		return out;
	}
