...
namespace prefabs {
	...
	entity_handle create_sample_bilmer2000(const logic_step step, vec2 pos, entity_id load_mag_id) {
		...
		gun.recoil.offsets = {
			{ vec2().set_from_degrees(1.75f*2.f) },
			{ vec2().set_from_degrees(1.75f*2.f) },
			{ vec2().set_from_degrees(1.75f*2.6f) },
			{ vec2().set_from_degrees(1.75f*2.8f) },
			{ vec2().set_from_degrees(1.75f*3.2f) },
			{ vec2().set_from_degrees(1.75f*3.0f) },
			{ vec2().set_from_degrees(1.75f*2.7f) },
			{ vec2().set_from_degrees(1.75f*2.3f) },
			{ vec2().set_from_degrees(1.75f*2.0f) },
			{ vec2().set_from_degrees(1.75f*0.3f) },
			{ vec2().set_from_degrees(1.75f*-0.5f) },
			{ vec2().set_from_degrees(1.75f*-1.0f) },
			{ vec2().set_from_degrees(1.75f*-1.5f) },
			{ vec2().set_from_degrees(1.75f*-2.f) },
			{ vec2().set_from_degrees(1.75f*-2.f) },
			{ vec2().set_from_degrees(1.75f*-2.f) },
			{ vec2().set_from_degrees(1.75f*-2.f) },
			{ vec2().set_from_degrees(1.75f*-2.f) },
			{ vec2().set_from_degrees(1.75f*-3.2f) },
			{ vec2().set_from_degrees(1.75f*-4.0f) },
			{ vec2().set_from_degrees(1.75f*2.3f) },
			{ vec2().set_from_degrees(1.75f*2.5f) },
			{ vec2().set_from_degrees(1.75f*1.7f) },
			{ vec2().set_from_degrees(1.75f*-2.f) },
			{ vec2().set_from_degrees(1.75f*-2.f) },
			{ vec2().set_from_degrees(1.75f*3.0f) },
		};
