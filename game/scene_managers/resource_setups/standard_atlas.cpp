...
namespace resource_setups {
	void load_standard_atlas() {
		resource_manager.create(assets::texture_id::TEST_CROSSHAIR, "hypersomnia/gfx/crosshair.png");
		resource_manager.create(assets::texture_id::TEST_PLAYER, "hypersomnia/gfx/walk_1.png");
		resource_manager.create(assets::texture_id::TEST_BACKGROUND, "hypersomnia/gfx/snow_textures/snow3.png");
		resource_manager.create(assets::texture_id::CRATE, "hypersomnia/gfx/crate2.png");
		resource_manager.create(assets::texture_id::CRATE_DESTROYED, "hypersomnia/gfx/crate2_destroyed.png");
		resource_manager.create(assets::texture_id::CAR_INSIDE, "hypersomnia/gfx/crate2.png");
		resource_manager.create(assets::texture_id::CAR_FRONT, "hypersomnia/gfx/crate2.png");

		resource_manager.create(assets::texture_id::MOTORCYCLE_FRONT, "hypersomnia/gfx/motorcycle_front.png");
		resource_manager.create(assets::texture_id::MOTORCYCLE_INSIDE, "hypersomnia/gfx/motorcycle_inside.png");

		resource_manager.create(assets::texture_id::TRUCK_FRONT, "hypersomnia/gfx/truck_front.png");
		resource_manager.create(assets::texture_id::TRUCK_INSIDE, "hypersomnia/gfx/truck_inside.png");

		resource_manager.create(assets::texture_id::TEST_SPRITE, "hypersomnia/gfx/frog.png");

		{
			auto& gui = resource_manager.create(assets::texture_id::ASSAULT_RIFLE, "hypersomnia/gfx/assault_rifle.png").gui_sprite_def;
		...
		{
			auto& gui = resource_manager.create(assets::texture_id::SUBMACHINE, "hypersomnia/gfx/submachine.png").gui_sprite_def;
			gui.flip_horizontally = true;
			gui.flip_vertically = true;
		}

		{
			auto& gui = resource_manager.create(assets::texture_id::PISTOL, "hypersomnia/gfx/pistol.png").gui_sprite_def;
			gui.flip_horizontally = true;
			gui.flip_vertically = true;
		}

		{
			auto& gui = resource_manager.create(assets::texture_id::URBAN_CYAN_MACHETE, "hypersomnia/gfx/urban_cyan_machete.png").gui_sprite_def;
			gui.flip_horizontally = true;
			gui.flip_vertically = true;
		}

		auto& magazine_gui = resource_manager.create(assets::texture_id::SAMPLE_MAGAZINE, "hypersomnia/gfx/magazine.png").gui_sprite_def;
		magazine_gui.rotation_offset = -270;

		auto& suppressor_gui = resource_manager.create(assets::texture_id::SAMPLE_SUPPRESSOR, "hypersomnia/gfx/suppressor.png").gui_sprite_def;
		suppressor_gui.flip_horizontally = true;

		resource_manager.create(assets::texture_id::ROUND_TRACE, "hypersomnia/gfx/round_trace.png");
		resource_manager.create(assets::texture_id::PINK_CHARGE, "hypersomnia/gfx/pink_charge.png");
		resource_manager.create(assets::texture_id::PINK_SHELL, "hypersomnia/gfx/pink_shell.png");
		resource_manager.create(assets::texture_id::CYAN_CHARGE, "hypersomnia/gfx/cyan_charge.png");
		resource_manager.create(assets::texture_id::CYAN_SHELL, "hypersomnia/gfx/cyan_shell.png");
		resource_manager.create(assets::texture_id::GREEN_CHARGE, "hypersomnia/gfx/green_charge.png");
		resource_manager.create(assets::texture_id::GREEN_SHELL, "hypersomnia/gfx/green_shell.png");

		auto& backpack_gui = resource_manager.create(assets::texture_id::BACKPACK, "hypersomnia/gfx/backpack.png").gui_sprite_def;
...
//		hud_circular_hud_medium.paint_circle_midpoint(48, 1, augs::white, true, -45, 45, false);
		...
		resource_manager.create(assets::texture_id::CONTAINER_OPEN_ICON, "hypersomnia/gfx/container_open_icon.png");
		resource_manager.create(assets::texture_id::CONTAINER_CLOSED_ICON, "hypersomnia/gfx/container_closed_icon.png");

		resource_manager.create(assets::texture_id::GUI_CURSOR, "hypersomnia/gfx/gui_cursor.png");
		resource_manager.create(assets::texture_id::GUI_CURSOR_ADD, "hypersomnia/gfx/gui_cursor_add.png");
		resource_manager.create(assets::texture_id::GUI_CURSOR_ERROR, "hypersomnia/gfx/gui_cursor_error.png");
		resource_manager.create(assets::texture_id::GUI_CURSOR_MINUS, "hypersomnia/gfx/gui_cursor_minus.png");

		resource_manager.create(assets::texture_id::BLANK, "hypersomnia/gfx/blank.png");
		resource_manager.create(assets::texture_id::DROP_HAND_ICON, "hypersomnia/gfx/drop_hand_icon.png");
		resource_manager.create(assets::texture_id::SECONDARY_HAND_ICON, "hypersomnia/gfx/secondary_hand_icon.png");
		resource_manager.create(assets::texture_id::PRIMARY_HAND_ICON, "hypersomnia/gfx/primary_hand_icon.png");
		resource_manager.create(assets::texture_id::SHOULDER_SLOT_ICON, "hypersomnia/gfx/shoulder_slot_icon.png");
		resource_manager.create(assets::texture_id::ARMOR_SLOT_ICON, "hypersomnia/gfx/armor_slot_icon.png");
		resource_manager.create(assets::texture_id::CHAMBER_SLOT_ICON, "hypersomnia/gfx/chamber_slot_icon.png");
		resource_manager.create(assets::texture_id::DETACHABLE_MAGAZINE_ICON, "hypersomnia/gfx/detachable_magazine_slot_icon.png");
		resource_manager.create(assets::texture_id::GUN_BARREL_SLOT_ICON, "hypersomnia/gfx/gun_barrel_slot_icon.png");
		
		resource_manager.create(assets::texture_id::DEAD_TORSO, "hypersomnia/gfx/dead_torso.png");
