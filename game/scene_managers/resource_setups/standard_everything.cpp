...
namespace resource_setups {
	void load_standard_everything() {
		...
		get_resource_manager().create(assets::atlas_id::GAME_WORLD_ATLAS,
		...
		get_resource_manager().create(assets::shader_id::DEFAULT_VERTEX, "hypersomnia/shaders/default.vsh", augs::graphics::shader::type::VERTEX);
		get_resource_manager().create(assets::shader_id::DEFAULT_FRAGMENT, "hypersomnia/shaders/default.fsh", augs::graphics::shader::type::FRAGMENT);
		get_resource_manager().create(assets::program_id::DEFAULT, assets::shader_id::DEFAULT_VERTEX, assets::shader_id::DEFAULT_FRAGMENT);

		get_resource_manager().create(assets::shader_id::DEFAULT_ILLUMINATED_VERTEX, "hypersomnia/shaders/default_illuminated.vsh", augs::graphics::shader::type::VERTEX);
		get_resource_manager().create(assets::shader_id::DEFAULT_ILLUMINATED_FRAGMENT, "hypersomnia/shaders/default_illuminated.fsh", augs::graphics::shader::type::FRAGMENT);
		get_resource_manager().create(assets::program_id::DEFAULT_ILLUMINATED, assets::shader_id::DEFAULT_ILLUMINATED_VERTEX, assets::shader_id::DEFAULT_ILLUMINATED_FRAGMENT);

		get_resource_manager().create(assets::shader_id::PURE_COLOR_HIGHLIGHT_VERTEX, "hypersomnia/shaders/pure_color_highlight.vsh", augs::graphics::shader::type::VERTEX);
		get_resource_manager().create(assets::shader_id::PURE_COLOR_HIGHLIGHT_FRAGMENT, "hypersomnia/shaders/pure_color_highlight.fsh", augs::graphics::shader::type::FRAGMENT);
		get_resource_manager().create(assets::program_id::PURE_COLOR_HIGHLIGHT, assets::shader_id::PURE_COLOR_HIGHLIGHT_VERTEX, assets::shader_id::PURE_COLOR_HIGHLIGHT_FRAGMENT);

		get_resource_manager().create(assets::shader_id::CIRCULAR_BARS_VERTEX, "hypersomnia/shaders/circular_bars.vsh", augs::graphics::shader::type::VERTEX);
		...
		get_resource_manager().create(assets::shader_id::SMOKE_VERTEX, "hypersomnia/shaders/fullscreen.vsh", augs::graphics::shader::type::VERTEX);
