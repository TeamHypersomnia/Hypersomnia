function create_character_animation_sets(npc_size_multiplier, duration_multiplier, images_table)
	...
	animations.legs = create_animation {
		frames = {
			...
			{ model = { image = images_table.legs_5,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier },
			{ model = { image = images_table.legs_4,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier },
			{ model = { image = images_table.legs_3,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier },
			{ model = { image = images_table.legs_2,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier },
			{ model = { image = images_table.legs_1,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier },
			{ model = { image = images_table.legs_2,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier },
			{ model = { image = images_table.legs_3,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier },
			{ model = { image = images_table.legs_4,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier },
			{ model = { image = images_table.legs_5,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier },
			{ model = nil, duration_ms = 2.0*duration_multiplier },                                                                    
			{ model = { image = images_table.legs_5,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier, callback = function(subject) subject.render.flip_vertically = true end, callback_out = function(subject) subject.render.flip_vertically = false end },
			{ model = { image = images_table.legs_4,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier, callback = function(subject) subject.render.flip_vertically = true end, callback_out = function(subject) subject.render.flip_vertically = false end },
			{ model = { image = images_table.legs_3,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier, callback = function(subject) subject.render.flip_vertically = true end, callback_out = function(subject) subject.render.flip_vertically = false end },
			{ model = { image = images_table.legs_2,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier, callback = function(subject) subject.render.flip_vertically = true end, callback_out = function(subject) subject.render.flip_vertically = false end },
			{ model = { image = images_table.legs_1,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier, callback = function(subject) subject.render.flip_vertically = true end, callback_out = function(subject) subject.render.flip_vertically = false end },
			{ model = { image = images_table.legs_2,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier, callback = function(subject) subject.render.flip_vertically = true end, callback_out = function(subject) subject.render.flip_vertically = false end },
			{ model = { image = images_table.legs_3,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier, callback = function(subject) subject.render.flip_vertically = true end, callback_out = function(subject) subject.render.flip_vertically = false end },
			{ model = { image = images_table.legs_4,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier, callback = function(subject) subject.render.flip_vertically = true end, callback_out = function(subject) subject.render.flip_vertically = false end },
			{ model = { image = images_table.legs_5,  size_multiplier = npc_size_multiplier*1.2 }, duration_ms = 20*duration_multiplier, callback = function(subject) subject.render.flip_vertically = true end, callback_out = function(subject) subject.render.flip_vertically = false end }
