...
struct image_definition_view : asset_definition_view<const image_definition> {
	...
	std::optional<cached_neon_map_in> should_regenerate_neon_map(const bool force_regenerate, const bool gore_enabled) const;
	void regenerate_neon_map(const cached_neon_map_in&, const bool gore_enabled) const;
