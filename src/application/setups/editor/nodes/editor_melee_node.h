...
struct editor_melee_node_editable {
	// GEN INTROSPECTOR struct editor_melee_node_editable
	vec2 pos;
...
struct editor_melee_node {
	editor_typed_resource_id<editor_melee_resource> resource_id;
	editor_melee_node_editable editable;
