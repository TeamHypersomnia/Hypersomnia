...
struct debugger_action_indicator_settings {
	// GEN INTROSPECTOR struct debugger_action_indicator_settings
...
struct debugger_settings {
	...
	debugger_action_indicator_settings action_indicator;
	// END GEN INTROSPECTOR
};