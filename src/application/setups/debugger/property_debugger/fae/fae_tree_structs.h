...
struct fae_property_debugger_input {
	commanding_property_debugger_input cpe_in;
};
...
struct fae_tree_input {
	...
	operator fae_property_debugger_input() const {
		return { cpe_in };
	}
};
...
struct edit_invariant_input {
	const fae_property_debugger_input fae_in;
