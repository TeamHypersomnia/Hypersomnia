...
namespace test_flavours {
	void populate_other_flavours(const loaded_game_image_caches& caches, all_entity_flavours& flavours);
	void populate_car_flavours(const loaded_game_image_caches& caches, all_entity_flavours& flavours);
	void populate_crate_flavours(const loaded_game_image_caches& caches, all_entity_flavours& flavours);
	void populate_melee_flavours(const loaded_game_image_caches& caches, all_entity_flavours& flavours);
	void populate_backpack_flavours(const loaded_game_image_caches& caches, all_entity_flavours& flavours);
	void populate_gun_flavours(const loaded_game_image_caches& caches, all_entity_flavours& flavours);
	void populate_grenade_flavours(const loaded_game_image_caches& caches, all_entity_flavours& flavours);
	void populate_character_flavours(const loaded_game_image_caches& caches, all_entity_flavours& flavours);
}
