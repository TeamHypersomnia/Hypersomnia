...
enum class test_scene_image_id {
	...
	METROPOLIS_TORSO_BARE_1,
	METROPOLIS_TORSO_RIFLE_1,
	METROPOLIS_TORSO_AKIMBO_1,

	METROPOLIS_TORSO_HEAVY_1,
	METROPOLIS_TORSO_HEAVY_SHOOT_1,

	RESISTANCE_TORSO_BARE_1,
	RESISTANCE_TORSO_RIFLE_1,
	RESISTANCE_TORSO_RIFLE_SHOOT_1,

	RESISTANCE_TORSO_HEAVY_WALK_1,
	RESISTANCE_TORSO_AKIMBO_WALK_1,
	RESISTANCE_TORSO_AKIMBO_SHOOT_1,
