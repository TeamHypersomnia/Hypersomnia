...
const std::unordered_set<entity_id_base>& flavour_id_cache::get_entities_by_flavour_id(const entity_flavour_id id) const {
	thread_local std::unordered_set<entity_id_base> none;
