...
using raw_mode_vars_id = unsigned;

template <class T>
using make_vars_map = std::unordered_map<raw_mode_vars_id, typename T::vars_type>;
...
using all_mode_vars_maps = per_type_container<all_modes, make_vars_map>;
