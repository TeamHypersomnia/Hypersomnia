...
using all_server_modes = type_list<
	bomb_mode
>;
...
using all_modes = concatenate_lists_t<all_server_modes, rest_of_modes>;

using all_modes_variant = replace_list_type_t<all_modes, std::variant>;
using all_server_modes_variant = replace_list_type_t<all_server_modes, std::variant>;
