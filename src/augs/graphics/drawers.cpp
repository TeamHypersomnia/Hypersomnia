...
namespace augs {
	...
	void draw_dashed_line(vertex_line_buffer& v, const vec2 from, const vec2 to, const texture_atlas_entry& tex, const rgba color, const float dash_length, const float dash_velocity, const double global_time_seconds) {
